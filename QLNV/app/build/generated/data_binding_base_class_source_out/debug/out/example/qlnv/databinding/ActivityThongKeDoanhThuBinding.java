...
public final class ActivityThongKeDoanhThuBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityThongKeDoanhThuBinding(@NonNull LinearLayout rootView, @NonNull Button btnHome,
  ...
  @NonNull
  public static ActivityThongKeDoanhThuBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityThongKeDoanhThuBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_thong_ke_doanh_thu, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityThongKeDoanhThuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityThongKeDoanhThuBinding((LinearLayout) rootView, btnHome, btnThongKe,
          edtDenNgay, edtTuNgay, lvThongKe, tvTongDoanhThu, tvTongHoaDon);
    }
